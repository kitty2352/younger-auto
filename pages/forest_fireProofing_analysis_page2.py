...
class forest_fireProofing_analysis_page2(Base):
    ...
    loc_water_resource = ('xpath', '//*[@id="tabset"]/div[2]')  # 防火资源-水源地
    loc_muldelete = ('xpath', './/app-analysis/div[2]/app-water-source/div[1]/div[2]/div[1]/button[1]')
    loc_position = ('xpath', './/app-analysis/div[2]/app-water-source/div[1]/div[2]/div[1]/button[2]')
    loc_addButton = ('xpath', './/app-analysis/div[2]/app-water-source/div[1]/div[2]/div[1]/button[3]')
    ...
    loc_resource_type = ('xpath', '//*/nz-modal/div/div[2]/div/div/div[2]/div/form/nz-form-item[4]/nz-form-control/div/span/input')
    loc_access_way = ('xpath', '//*/nz-modal/div/div[2]/div/div/div[2]/div/form/nz-form-item[5]/nz-form-control/div/span/input')
    loc_storage = ('xpath', '//*/nz-modal/div/div[2]/div/div/div[2]/div/form/nz-form-item[6]/nz-form-control/div/span/input')
    ...
    # 搜索功能元素定位
    loc_search_input = ('xpath', '//*/app-analysis/div[2]/app-water-source/div[1]/div[2]/div[2]/input')
    loc_search_btn = ('xpath', '//*/app-analysis/div[2]/app-water-source/div[1]/div[2]/div[2]/button')
    loc_search_datas = ('xpath', '//*/app-analysis/div[2]/app-water-source/div[1]/div[3]/nz-table/nz-spin/div/div/div/div/div[2]/table/tbody/tr')

    # 删除功能元素定位
    loc_delete_message = ('xpath', '//*[@class="cdk-overlay-pane"]/nz-message-container/div/nz-message')
    loc_delete_choose_first = ('xpath', '//*/app-analysis/div[2]/app-water-source/div[1]/div[3]/nz-table/nz-spin/div/div/div/div/div[2]/table/tbody/tr[1]/td[1]/label/span[1]/input')
    loc_delete_choose_all = ('xpath', '//*/app-analysis/div[2]/app-water-source/div[1]/div[3]/nz-table/nz-spin/div/div/div/div/div[1]/table/thead/tr/th[1]/span/div/span/label/span[1]/input')
    ...
    # 分页功能元素
    loc_pagination1 = ('xpath', '//*/app-analysis/div[2]/app-water-source/div[1]/div[4]/nz-pagination/ul')
    loc_pagination = ('css selector', 'app-analysis>div.dummy>app-water-source>div.left>div.pagination>nz-pagination>ul>li:nth-last-child(2)')
    loc_lastPage = ('xpath', '//*/app-analysis/div[2]/app-water-source/div[1]/div[4]/nz-pagination/ul/li[1]/button')
    loc_nextPage = ('css selector', 'app-analysis>div.dummy>app-water-source>div.left>div.pagination>nz-pagination>ul>li:last-child>button')
    loc_allPage = ('css selector', 'app-analysis>div.dummy>app-water-source>div.left>div.pagination>nz-pagination>ul>li')
    ...
    def login(self):
        ...
        # 点击水源地
        self.click(self.loc_water_resource)
    ...
    # 输入水源类型
    def input_loc_resource_type(self, loc_resource_type):
        self.send_keys(self.loc_resource_type, loc_resource_type)

    # 输入取水方式
    def input_loc_access_way(self, loc_access_way):
        self.send_keys(self.loc_access_way, loc_access_way)

    # 输入蓄水量
    def input_loc_storage(self, loc_storage):
        self.send_keys(self.loc_storage, loc_storage)
    ...
    # 添加方法(不带参)
    def addWaterResource(self):
        self.click(self.loc_addButton)

        self.input_resource_name("test10")
        self.input_loc_location('大河坝边上')
        self.chooseDepartment()
        self.input_loc_resource_type("水坝")
        self.input_loc_access_way("人工")
        self.input_loc_storage('1000')
    ...
    # 添加方法（带参）
    def addWaterResource1(self, resource_name, location, resource_type, access_way='', storage='', latitude='', longitude='', remark=''):
        # 获取队伍名称
        ...
        self.chooseDepartment()
        self.input_loc_resource_type(resource_type)
        self.input_loc_access_way(access_way)
        self.input_loc_storage(storage)
    ...
    def skip_page_to(self, pageNumber):
        if pageNumber > self.get_total_page() or int(pageNumber) < 1:
            print("页码超出范围")
        else:
